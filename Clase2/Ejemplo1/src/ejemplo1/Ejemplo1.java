...
public class Ejemplo1 {
 ...
 /*
        ...
        //Guardando el valor de "Luis" en el arreglo "nombres" en la posición 2 e índice 1
        nombres[1] = "Luis";

        //----------ACCEDER A VALORES GUARDADOS EN UN ARREGLO--------
        System.out.println("--------VER VALORES DE GUARDAROS EN EL ARREGLO------");
        //Accediendo a un índice en específico del arreglo "notas"
        System.out.println("Imprimiendo indice 0 de nota: " + notas[0]);
        System.out.println("Imprimiendo indice 3 de nota: " + notas[3]);
        System.out.println("Imprimiendo indice 7 de nota: " + notas[7]);

        //Accediendo a un índice en específico del arreglo "nombres"
        System.out.println("Imprimiendo indice 1 de nombres: " + nombres[1]);
 ...
 /* Por ejemplo, si deseamos guardar en la matriz el valor 5, en la posición de la matriz [1,4]=[fila, columna]
        ...
        System.out.println("--------VER VALORES DE GUARDAROS EN LA MATRIZ------");
        //Accediendo a un índice en específico de la matriz
        System.out.println("Imprimiendo indice [1][3]: " + matriz[1][3]);

        System.out.println("Imprimiendo indice [1][1]: " + matriz[1][1]);
        ...
        System.out.println("--------LISTAS DINAMICAS-----------");
        //-----------LISTAS DINAMICAS----------
        ...
        /*NOTAR QUE EN LA CREACIÓN DE LAS LISTAS DINAMICAS NO LE COLOCAMOS UN TAMAÑO INICIAL
        YA QUE AL SER DINIMICO, IRÁ AUMENTANDO DURANTE LA EJECUCIÓN DEL PROGRAMA*/
        ...
        System.out.println("Imprimiendo indice 1: " + listaDinamica.get(1));
        ...
        //Modificando un índice de un arreglo:  listaDinamica.set(índice que deseamos modificar,"Nuevo valor")
        listaDinamica.set(1, "Modificado"); 

        System.out.println("Imprimiendo indice 1 ya modificado: " + listaDinamica.get(1));
